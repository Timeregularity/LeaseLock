...
const accounts = [
  {
    email: process.env.SEED_ADMIN_EMAIL || 'admin@leaselock.local',
    password: process.env.SEED_ADMIN_PASSWORD || 'Admin123!',
    fullName: 'LeaseLock Admin',
    role: 'ADMIN',
  },
  {
    email: process.env.SEED_CUSTOMER_EMAIL || 'customer@leaselock.local',
...
const events = [
  {
    ...
    name: 'TechFest Live',
    description:
      'An evening of ambitious ideas, practical engineering stories, and live product demonstrations.',
    venue: 'Main Auditorium',
    startsAt: '2035-08-25T13:30:00.000Z',
  },
  {
    slug: 'systems-summit',
    name: 'Systems Summit',
    description: 'Deep dives into distributed systems, reliability, and resilient products.',
    venue: 'Innovation Hall',
    startsAt: '2035-09-02T05:00:00.000Z',
  },
  {
    slug: 'design-code',
    name: 'Design × Code',
    description:
      'A focused conversation about bringing design craft and engineering discipline together.',
...
events.push(
  {
    ...
    description: 'A late-night set of modern jazz, improvisation, and intimate live performances.',
    venue: 'Riverside Pavilion',
    startsAt: '2035-10-04T14:30:00.000Z',
  },
  {
    slug: 'makers-market',
    name: 'Makers Market',
    description:
      'Meet local makers, try hands-on workshops, and discover independent creative work.',
    venue: 'City Exhibition Centre',
    startsAt: '2035-10-18T05:30:00.000Z',
  },
  {
    slug: 'film-under-stars',
    name: 'Film Under the Stars',
    description:
      'An open-air cinema evening with a curated feature, food stalls, and community seating.',
    venue: 'Lakeside Lawn',
    startsAt: '2035-11-08T12:30:00.000Z',
  },
);
...
async function seed() {
  ...
  console.log(
    `Seeded ${accounts.length} accounts, ${events.length} events, and ${events.length * 40} seats.`,
  );
